...
static token_t make_token(tok_type_e type) {
    token_t token;
    token.type = type;
...
static tok_type_e check_keyword(int start, int length,
                                const char *rest, tok_type_e type) {
...
static tok_type_e identifier_type() {
